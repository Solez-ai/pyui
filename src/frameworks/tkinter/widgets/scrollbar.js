...
class Scrollbar extends TkinterWidgetBase{
    ...
    generateCode(variableName, parent){
        ...
        const orient = this.getAttrValue("orientation") === "horizontal" ? "tk.HORIZONTAL" : "tk.VERTICAL"

        return [
                `${variableName} = tk.Scrollbar(master=${parent}, orient=${orient})`,
