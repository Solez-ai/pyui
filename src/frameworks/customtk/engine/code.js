...
export function generateCustomTkCodeList(widgetList = [], widgetRefs = [], parentVariable = null, mainVariable = "", usedVariableNames = new Set()) {
 ...
 */
export function getCustomTkCodeString(widgetList = [], widgetRefs = [], options = {}) {
 ...
 */
export function generateCustomTkWidgetCodeString(widget, widgetRefs, parentVariable = "") {

    const generatedObject = generateCustomTkCodeList([widget], widgetRefs, parentVariable, "")
...
async function generateCustomTkCode(projectName, widgetList=[], widgetRefs=[], assetFiles){
    ...
    const result = getCustomTkCodeString(widgetList, widgetRefs.current)

    if (!result){
        return
    }

    const {code, requirements} = result
