...
class Combobox extends CustomTkWidgetBase{
    ...
    generateCode(variableName, parent){
        ...
        const code = [
            `${variableName} = ctk.CTkComboBox(master=${parent}, values=${JSON.stringify(options)})`,
        ]

        if (defaultValue){
            code.push(`${variableName}.set("${defaultValue}")`)
        }
