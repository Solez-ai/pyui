...
class LabelFrame extends CustomTkBase{
    ...
    generateCode(variableName, parent){
        ...
        return [
                `${variableName}_title = ctk.CTkLabel(master=${parent}, text="${this.getAttrValue("labelText")}")`,
                `${variableName} = ctk.CTkFrame(master=${parent})`,
                `${variableName}_title.place(x=10, y=2)`,
