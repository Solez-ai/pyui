...
class TodoList extends CustomTkWidgetBase{
    ...
    generateCode(variableName, parent){
        ...
        return [
            ...
            `${variableName}_add_btn = ctk.CTkButton(master=${parent}, text="Add", command=${variableName}_add_task)`,
            `${variableName}_listbox = tk.Listbox(master=${parent}, height=6)`,
            `${variableName}_remove_btn = ctk.CTkButton(master=${parent}, text="Remove selected", command=${variableName}_remove_task)`,
