    ...
    return (
        <div className={`tw-relative tw-duration-[0.3s] tw-transition-all
                        ...
                        ${sidebarOpen ? "tw-bg-white tw-min-w-[350px] tw-w-[350px] tw-shadow-lg": 
                            "tw-bg-white tw-min-w-[80px] tw-w-[80px]"}
                        `} 
                        ref={sideBarRef} 
            ...
            <div className="tw-min-w-[80px] tw-w-[80px] tw-bg-white tw-border-0 tw-border-r tw-border-solid tw-border-gray-200 tw-h-full tw-flex tw-flex-col tw-gap-4 tw-p-3 tw-place-items-center">
                {
                    sidebarTabs.map((tab, index) => {
                        return (
                            <div className={`${activeTab === index ? "tw-text-blue-500" :  "tw-text-gray-600"} 
                                 ...
                                 >
                                <div className={`${activeTab === index ? "tw-border-solid tw-border-[1px] tw-border-blue-500 tw-bg-blue-50" : "tw-border-solid tw-border-[1px] tw-border-gray-200 tw-bg-white"} tw-shadow-sm tw-p-2 tw-rounded-md`}>
                                    {tab.icon}
                                </div>
                ...
                <div className="tw-mt-auto tw-text-[11px] tw-text-center tw-text-gray-500 tw-leading-tight">
                    Samin<br />Yeasar
                </div>
            </div>
            ...
            <div className="tw-w-full tw-h-full tw-bg-inherit tw-rounded-lg
                ...
                ref={sideBarExtraRef}>
                <div className="tw-w-full tw-h-[50px] tw-flex tw-place-content-between tw-place-items-center tw-px-3">
                    <span className="tw-text-sm tw-font-semibold tw-text-gray-800">
                        {(activeTab > -1 || hoverIndex > -1) && tabs[activeTab > -1 ? activeTab : hoverIndex].name}
                    </span>
